		...
		<Surface style={{ flex: 1 }}>
			...
			<SafeAreaView>
				<View style={{ height: '80%' }}>
					<Image
						source={Logo}
						style={{ height: '6%', resizeMode: 'contain', alignSelf: 'center', marginBottom: 10 }}
					/>
					<Image
						source={WelcomeDesign}
						style={{ height: '80%', resizeMode: 'contain', alignSelf: 'center', marginTop: 10 }}
					/>
					<View style={{ alignItems: 'center', marginTop: -20 }}>
						<Text style={styles.text}>Welcome to Nigeria’s Largest Pharmacy Partner</Text>
					</View>
				</View>
				<View style={{ marginHorizontal: 30, marginTop: 10 }}>
					...
					<View style={{ flexDirection: 'row', justifyContent: 'center' }}>
						...
						<TouchableOpacity onPress={() => navigation.navigate('register')}>
							<Caption style={{ marginTop: 15, color: '#4B70D6', fontWeight: 'bold' }}>REGISTER</Caption>
						</TouchableOpacity>
					</View>
				</View>
			</SafeAreaView>
